...
int DijetImbalanceRatio(const std::string flatPthatFileName, const std::string stagPthatFileName)
{
  ...
  TH1D* dijet_flatPthat_Unweighted_h = new TH1D("dijet_flatPthat_Unweighted_h", ";Flat X_J (Unweighted);Counts (Unweighted)", 10, 0, 1);
  TH1D* dijet_flatPthat_Weighted_h = new TH1D("dijet_flatPthat_Weighted_h", ";Flat X_J (Weighted);Counts (Weighted)", 10, 0, 1);
  TH1D* dijet_stagPthat_Unweighted_h = new TH1D("dijet_stagPthat_Unweighted_h", ";Stag X_J (Unweighted);Counts (Unweighted)", 10, 0, 1);
  TH1D* dijet_stagPthat_Weighted_h = new TH1D("dijet_stagPthat_Weighted_h", ";Stag X_J (Weighted);Counts (Weighted)", 10, 0, 1);
  TH1D* dphi_flatPthat_Unweighted_h = new TH1D("dphi_flatPthat_Unweighted_h", ";Flat |#Delta#phi|;Counts (Unweighted)", 20, 0, pi);
  TH1D* dphi_flatPthat_Weighted_h = new TH1D("dphi_flatPthat_Weighted_h", ";Flat |#Delta#phi|;Counts (Weighted)", 20, 0, pi);
  TH1D* dphi_stagPthat_Unweighted_h = new TH1D("dphi_stagPthat_Unweighted_h", ";Stag |#Delta#phi| (Unweighted);Counts (Unweighted)", 20, 0, pi);
  TH1D* dphi_stagPthat_Weighted_h = new TH1D("dphi_stagPthat_Weighted_h", ";Stag |#Delta#phi| (Unweighted);Counts (Weighted)", 20, 0, pi);
  std::vector<TH1*> tempVect = {dijet_flatPthat_Unweighted_h, dijet_flatPthat_Weighted_h, dijet_stagPthat_Unweighted_h, dijet_stagPthat_Weighted_h, dphi_flatPthat_Unweighted_h, dphi_flatPthat_Weighted_h, dphi_stagPthat_Unweighted_h, dphi_stagPthat_Weighted_h};
  ...
  //Do Clones
  TH1D* dijet_flatPthat_Unweighted_Scale_h = (TH1D*)dijet_flatPthat_Unweighted_h->Clone("dijet_flatPthat_Unweighted_Scale_h");
  TH1D* dijet_flatPthat_Unweighted_ScaleRelErr_h = (TH1D*)dijet_flatPthat_Unweighted_h->Clone("dijet_flatPthat_Unweighted_ScaleRelErr_h");
  TH1D* dphi_flatPthat_Unweighted_Scale_h = (TH1D*)dphi_flatPthat_Unweighted_h->Clone("dphi_flatPthat_Unweighted_Scale_h");
  TH1D* dphi_flatPthat_Unweighted_ScaleRelErr_h = (TH1D*)dphi_flatPthat_Unweighted_h->Clone("dphi_flatPthat_Unweighted_ScaleRelErr_h");

  dijet_flatPthat_Unweighted_ScaleRelErr_h->GetYaxis()->SetTitle("Relative Error, 7E10stat");
  dphi_flatPthat_Unweighted_ScaleRelErr_h->GetYaxis()->SetTitle("Relative Error, 7E10stat");
  ...
  //Do Clones
  TH1D* dijet_stagPthat_Unweighted_Scale_h = (TH1D*)dijet_stagPthat_Unweighted_h->Clone("dijet_stagPthat_Unweighted_Scale_h");
  TH1D* dijet_stagPthat_Unweighted_ScaleRelErr_h = (TH1D*)dijet_stagPthat_Unweighted_h->Clone("dijet_stagPthat_Unweighted_ScaleRelErr_h");

  dijet_stagPthat_Unweighted_ScaleRelErr_h->GetYaxis()->SetTitle("Relative Error, 7E10stat");
  ...
  TH1D* dphi_stagPthat_Unweighted_Scale_h = (TH1D*)dphi_stagPthat_Unweighted_h->Clone("dphi_stagPthat_Unweighted_Scale_h");
  TH1D* dphi_stagPthat_Unweighted_ScaleRelErr_h = (TH1D*)dphi_stagPthat_Unweighted_h->Clone("dphi_stagPthat_Unweighted_ScaleRelErr_h");

  dphi_stagPthat_Unweighted_ScaleRelErr_h->GetYaxis()->SetTitle("Relative Error, 7E10stat");
